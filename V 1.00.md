...
def create_scene():
    ...
    if not cmds.ls('SkydomeLight'):
        ...
        cmds.setAttr(skydome + '.intensity', 0.1)
        cmds.setAttr(skydome + '.color', 1, 1, 1, type='double3')  # افزودن گرادینت آسمان در اینجا بسته به تنظیمات محیطی
    ...
    if not cmds.ls('DirectionalLight'):
        ...
        cmds.rotate(-45, 45, 0, directional)
